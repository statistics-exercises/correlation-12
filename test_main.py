...
class UnitTests(unittest.TestCase) :
      def test_plot(self) :
          ...
          for i in range(len(this_x)) :
              ...
              self.assertTrue( this_y[i]<this_x[i]*this_x[i]+0.5 and this_y[i]>this_x[i]*this_x[i]-0.5, "One or more of your coordinates falls outside of the region of interest" )
